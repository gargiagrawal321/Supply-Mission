...
function setup() {
	...
	packageSprite.addImage("img",packageI);
...
function draw() {
  ...
  rect(boxPosition,boxY,20,100);
  rect(boxPosition+100,boxY+45,200,20);
  rect(boxPosition+200,boxY,20,100)
...
//spelling of keyPressed was wrong
function keyPressed(){
